...
@everywhere if gethostname() == "Michi-T450s"
...
elseif gethostname() == "LINUX24"
    ...
    outpath = joinpath(datapath, "2dmrd", "db_tot")
else #HYPERION
    importdir = "/home/haugened/ibl_patch_snow/code/"
    datapath = "/home/haugened/mrd/data/"
    outpath = "/home/haugened/mrd/output_data/"
end
